...
#SBATCH --job-name=Array_TBAssemble_uncombined
#SBATCH --array=112-227:1
...
date
time snakemake -s Snakefile_align --cores all --use-conda -j 1 -w 30 --rerun-incomplete --rerun-triggers mtime --configfile ${CFG_FILE} --nolock
date
